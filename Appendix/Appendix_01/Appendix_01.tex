...
%
\begin{equation}
\delta \underline{OE} = \underline{f} \left( \underline{OE_C}, \underline{OE_D} \right)
\label{eq:	ROE_def}
\end{equation}
...
%
	...
	C_2 = e\delta p - p \delta e &   &   &  [L] \\
	C_3 = -e\, p \left(\delta \omega + \cos i \delta \Omega\right)&   &   &   \\
	C_4 = a \left( \delta\omega + \cos i \delta \Omega + \eta^{-1} \delta M\right)&   &   &   \\
	C_5 = -p\left( \cos\omega \delta i + \sin i \sin\omega \delta \Omega \right)&   &   &   \\
	C_6 = p\left( \sin\omega \delta i - \sin i \cos \omega \delta \Omega \right)&   &   &   \\
	\end{array}\right.
	\end{equation}
	%
