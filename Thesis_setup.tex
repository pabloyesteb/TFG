...
%	framexleftmargin=2em, % Ajusta el margen izquierdo
	xleftmargin=2em,
	escapeinside={(*@}{@*)}, % Delimitador para el modo matemático
}
...
\newlength{\imagenwidth}
\settowidth{\imagenwidth}{\includegraphics{/home/pablo/Documentos/TFGP/Thesis/Figures/tt-split/geo.png}}

% The former image is considered to be in the document adjusted to the textwidth.
\edef\tabscale{\fpeval{\textwidth/\imagenwidth}}
%% === === === === === === HYPERREF SETUP  === === === === === ===
