...
\node (decision)	[decision, font = \small, minimum size = 30mm] {$SC \overset{\mathord{?}}{=} $`Target'};	& \node (SC_yes)	[cloud] 		{Yes}; 						&
...
% ----------- GRAPH ----------
\node (prop_text)	[GMVred!70, above = 14ex of yTECI0]		{\huge{\code{propRK4\_HiFi} workflow}};
\begin{pgfonlayer}{background}
\draw	[GMVred!50, thick, fill = GMVred, opacity = 0.05] 	($(OE_ref.north west) - (5ex, -3ex)$) rectangle ($(prop_tf.south east) - (0ex, 15ex)$);
\end{pgfonlayer}
