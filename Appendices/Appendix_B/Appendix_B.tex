...
%
	...
	%
		...
		%
		\begin{itemize}
		\item[\GMVred{$\bullet$}] \myul[GMVred]{Semimajor axis}: Directly from energy equation:
		%
		\[
		a = \dfrac{r}{2 - \dfrac{r v^2}{\mu}}
		\]
		%
		\item[\GMVred{$\bullet$}] \myul[GMVred]{Eccentricity}: Prior relations arise from (a) the dot product of velocity and position and (b) the polar equation of the ellipse:
		%
		\[
		\begin{array}{ccc}
		\left\{ \begin{array}{lll}
		...
		%
		%
		\item[\GMVred{$\bullet$}] \myul[GMVred]{Inclination} From the orientation of the angular momentum vector:
		%
		\[
		...
		%
		\subparagraph{\GMVred{Case A)} Non-singular eccentricity or inclination.\\}
		%
		\[
		\left\{
		\begin{array}{lll}
		...
		\]
		%
		\subparagraph{\GMVred{Case B)} Null inclination, non-singular eccentricity. \\}
		%
		\[
		\left\{
		\begin{array}{lll}
		...
		\]
		%
		\subparagraph{\GMVred{Case C)} Null eccentricity, non-singular inclination. \\}
		%
		...
		\]
		%
		\subparagraph{\GMVred{Case D)} Null eccentricity and inclination. \\}
		%
		\[
		\left\{
		\begin{array}{lll}
