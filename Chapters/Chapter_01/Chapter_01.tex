...
\begin{table}[!htb]
	\centering
	\captionof{table}{Voxel outside hypercube}
	\label{tab:outhypercube}
	\includegraphics[width=1\textwidth]{/home/pablo/Documentos/TFGP/Thesis/Figures/tt-split/outside_hypercube.png}
\end{table}
